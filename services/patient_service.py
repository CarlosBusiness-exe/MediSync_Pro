...
class PatientService:
    ...
    @staticmethod
    def update_patient(patient_id: int, patient_data: PatientSchemaBase, db: Session):
        patient_up = PatientService.get_patient_by_id(patient_id, db)
    ...
    def delete_patient(patient_id: int, db: Session):
        patient_del = PatientService.get_patient_by_id(patient_id, db)
